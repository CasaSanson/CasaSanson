...
export default function Catalogo() {
    return (
        <main className="bg-white min-h-screen w-[100%] mx-auto">
            ...
            <section className="w-full mx-auto bg-black h-[20%] pt-[5%]">
            ...
            <section className="w-full mx-auto bg-[url(/black.jpeg)] bg-cover bg-center w-[80%] h-[80%]">
            ...
            {/* Productos */}
            <section className="w-full mx-auto bg-white bg-cover bg-center h-full pt-[5%]">
                <h1 className="text-4xl font-bold text-center text-black">PRODUCTS</h1>
                <div className="grid grid-cols-3 gap-4 max-w-[95%] mx-auto ">
                    {products.map((product) => (
                        <div key={product.id} className="flex flex-col items-start justify-start">
                           <Link href={`/catalogo/${product.id}`} className="w-full h-full">
            ...
            <section className="w-[80%] mx-auto h-[40vh] bg-white pt-[5%]">
